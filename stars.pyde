...
def draw():
    ...
    while (stars_x >= 50) and stars_x <= 5000 and (stars_y >= 200) and stars_y <= 20000:
        ellipse(stars_x, stars_y, 5, 5)
        stars_x += random.randint(50, 100)
        stars_y += random.randint(200, 350)
'''
        int i = 0;
while (i < 80) {
  line(30, i, 80, i);
